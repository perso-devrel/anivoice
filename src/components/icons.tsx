...
function StrokeIcon({ className, strokeWidth = 2, children }: StrokeIconProps) {
  return (
...
export function FileIcon({ className = 'w-12 h-12' }: IconProps) {
  return (
    <StrokeIcon className={className} strokeWidth={1.5}>
      ...
      <path d="M6 2.25h7.379a1.125 1.125 0 0 1 .795.33l4.246 4.245c.211.211.33.497.33.796V21.75a1.125 1.125 0 0 1-1.125 1.125H6a1.125 1.125 0 0 1-1.125-1.125V3.375C4.875 2.754 5.379 2.25 6 2.25Z" />
    </StrokeIcon>
  );
}
...
export function CheckIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
    <StrokeIcon className={className} strokeWidth={3}>
...
export function StarIcon({ className = 'w-4 h-4', fill = 'none' }: IconProps & { fill?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} fill={fill} strokeLinecap="round" strokeLinejoin="round">
...
export function LinkIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
    <StrokeIcon className={className}>
      <path d="M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m9.86-2.04a4.5 4.5 0 0 0-1.242-7.244l-4.5-4.5a4.5 4.5 0 0 0-6.364 6.364L4.34 8.374" />
    </StrokeIcon>
  );
}
...
export function VoiceIcon({ className = 'w-8 h-8' }: IconProps) {
  return (
    <StrokeIcon className={className} strokeWidth={1.5}>
      <path d="M12 18.75a6 6 0 006-6v-1.5m-6 7.5a6 6 0 01-6-6v-1.5m6 7.5v3.75m-3.75 0h7.5M12 15a3 3 0 003-3V6a3 3 0 10-6 0v6a3 3 0 003 3z" />
    </StrokeIcon>
  );
}
...
export function VideoPlayIcon({ className = 'w-10 h-10' }: IconProps) {
  return (
    <StrokeIcon className={className} strokeWidth={1.2}>
