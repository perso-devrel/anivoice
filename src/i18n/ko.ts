export default {
  ...
  auth: {
    ...
    verifyDesc: '{{email}} 으로 인증 메일을 보냈어요. 메일함의 링크를 눌러 인증을 완료하세요.',
    verifySpamHint: '메일이 보이지 않으면 스팸함도 확인해 주세요.',
    verifyResend: '인증 메일 다시 보내기',
    verifyResent: '인증 메일을 다시 보냈어요.',
    verifyCheck: '인증 완료 확인',
    verifyNotYet: '아직 인증이 완료되지 않았어요. 메일함을 다시 확인해 주세요.',
    verifyDone: '이메일 인증이 완료되었습니다.',
    verifySignOut: '다른 계정으로 로그인',
  },
  landing: {
    heroTitle: '자막 읽느라\n화면을 놓치지 마세요',
    heroSubtitle: '좋아하는 애니메이션을 원작 캐릭터의 음색 그대로, 당신의 언어로 즐기세요.',
    ctaPrimary: '시작하기',
    ctaSecondary: '공개 영상 보기',
    ...
    faqFormatA: '현재 MP4, MOV, WebM 형식을 지원합니다.',
    faqEditQ: 'AI가 생성한 번역을 수정할 수 있나요?',
    faqEditA: '네! 번역 편집기에서 원하는 구간의 번역을 수정하고, 전체 영상을 재처리하지 않고 해당 부분만 재생성할 수 있습니다.',
    videoOriginal: '원본',
  ...
  studio: {
    ...
    publishedMessage: '아카이브에 공개되었습니다.',
  ...
  settings: {
    ...
    status: '상태',
    paid: '결제 완료',
    billingBasicPlan: '크레딧 충전',
    billingCreditPack: '크레딧 패키지 구매',
    txTypePurchase: '크레딧 충전',
    txTypeDubbingDeduct: '더빙 사용',
    txTypeUnknown: '기타',
    noTransactions: '결제 내역이 없습니다',
    loadingTransactions: '내역을 불러오는 중...',
  ...
  onboarding: {
    ...
    step3Desc: '더빙된 영상, 자막, 오디오를 다운로드하거나 아카이브에 공유하세요.',
    next: '다음',
    skip: '건너뛰기',
    startNow: '시작하기',
  },
