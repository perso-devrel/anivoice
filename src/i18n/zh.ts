export default {
  ...
  auth: {
    ...
    verifyTitle: '请验证您的邮箱',
    verifyDesc: '我们已向 {{email}} 发送了验证邮件。请点击邮箱中的链接完成验证。',
    verifySpamHint: '如未收到邮件，请检查垃圾邮件文件夹。',
    verifyResend: '重新发送验证邮件',
    verifyResent: '验证邮件已重新发送。',
    verifyCheck: '我已完成验证',
    verifyNotYet: '尚未完成验证，请再次检查您的邮箱。',
    verifyDone: '邮箱验证已完成。',
    verifySignOut: '使用其他账号登录',
  },
  landing: {
    heroTitle: '不再错过画面\n享受字幕之外的世界',
  ...
  onboarding: {
    ...
    step3Title: '查看结果并下载',
    step3Desc: '下载配音视频、字幕、音频，或分享到档案馆。',
    next: '下一步',
    skip: '跳过',
    startNow: '开始',
  },
