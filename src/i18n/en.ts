export default {
  ...
  auth: {
    ...
    verifyDesc: "We've sent a verification link to {{email}}. Click the link in your inbox to finish setting up your account.",
    verifySpamHint: "Don't see it? Check your spam folder.",
    verifyResend: 'Resend verification email',
    verifyResent: 'Verification email sent again.',
    verifyCheck: 'I have verified',
    verifyNotYet: 'Not verified yet. Please check your inbox again.',
    verifyDone: 'Email verified successfully.',
    verifySignOut: 'Use a different account',
  },
  landing: {
