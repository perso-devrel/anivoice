...
- **마지막 iteration:** #127 — 중복 LANGUAGES 상수를 src/constants.ts로 추출 (LandingPage + StudioPage), dub-flow exit 77 upstream-down 지속
- **다음 루프가 기대하는 출발점:**
  - P0 전부 완료, P1 전부 완료, P2 32개 + 자가생성 27개 완료
  - vitest 설정 완료, `npm run test`로 376개 유닛 테스트 실행 가능 (api/ 포함)
  ...
  - 메인 번들 257KB, StudioPage 19.0KB, DashboardPage 18.3KB, UsageChart 346KB (recharts lazy)
